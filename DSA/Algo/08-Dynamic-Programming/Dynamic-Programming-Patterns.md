...
public class FibMemo {
    ...
    public static void main(String[] args) {
        System.out.println(fib(10, new HashMap<>())); // 55
    }
}
```
...
public class Knapsack01 {
    ...
    public static void main(String[] args) {
        int[] weights = {2, 3, 4, 5};
        int[] values = {3, 4, 5, 6};
        System.out.println(knapsack01(weights, values, 5)); // 7
    }
}
```
...
public class LISOptimized {
    ...
    public static void main(String[] args) {
        int[] nums = {10, 9, 2, 5, 3, 7, 101, 18};
        System.out.println(lisOptimized(nums)); // 4
    }
}
```
...
public class UnboundedKnapsack {
    ...
    public static void main(String[] args) {
        int[] weights = {2, 3, 4};
        int[] values = {3, 4, 5};
        System.out.println(unboundedKnapsack(weights, values, 5)); // 7 (3+4)
    }
}
```
