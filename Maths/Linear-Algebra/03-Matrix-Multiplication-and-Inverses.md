...
**What does this mean for matrix algebra?** Always check $(AB)^{-1} = B^{-1}A^{-1}$, not $A^{-1}B^{-1}$. Order reverses for both inverses and [[05-Transposes-Permutations-Spaces|transposes]].
